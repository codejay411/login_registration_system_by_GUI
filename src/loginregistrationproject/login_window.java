...
public class login_window extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BUNDELKHAND UNIVERSITY, JHANSI KANPUR ROAD");
        ...
        jTextFieldemailid.setForeground(new java.awt.Color(51, 51, 255));

        jPasswordFieldpass.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPasswordFieldpass.setForeground(new java.awt.Color(255, 51, 51));

        login.setBackground(new java.awt.Color(255, 255, 255));
        login.setFont(new java.awt.Font("Algerian", 0, 20)); // NOI18N
        ...
        reset.setFont(new java.awt.Font("Algerian", 0, 20)); // NOI18N
        ...
        jLabel5.setText("Don't have account ???  Click here to create ");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(54, 54, 54)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jTextFieldemailid, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jPasswordFieldpass, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(67, 67, 67)
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        // TODO add your handling code here
        //check or verify the user is valid or not
        ...
        {
            JOptionPane.showMessageDialog(null, "all fields are compulsary to fill , kindly check missing"+
                    " field in login form");
        }
        else{
            try{
            Connection con=myc.getconn();  // got the connection with database
            String sql="select * from users where email=? and password=?";
                ...
                JOptionPane.showMessageDialog(null, "databse exception error...."+e.getStackTrace()[0]);
                //e.getStackTrace()[0]  ---> gives us the exception with the line number of code which occur exception.
            }
